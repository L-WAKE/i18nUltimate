<template>
  <div class="page-content">
      ...
      <!-- <div class="left-tree">
                ...
                <div class="select-opt">
                    <div class="open" @click="openAll">
                        ...
                        <span>{{ listReactive.isExpand ? $t('i18n3') : $t('i18n4') }}{{ $t('i18n5') }}</span>
                    </div>
                </div>
        ...
        <div class="search-box">
          <div class="condition">
            <div class="select-tree-node">
              <div class="tree-text">{{ $t('i18n6') }}</div>
            ...
            <div class="condition-key">
              <span class="search-text">{{ $t('i18n7') }}</span>
            ...
            <div class="condition-key">
              <span class="search-text">{{ $t('i18n8') }}</span>
            ...
            <div class="condition-key">
              <span class="search-text">{{ $t('i18n9') }}</span>
              <n-input clearable
                class="search-ipt pr"
                v-model:value="queryParams.keyWords"
                type="text"
                :placeholder="$t('i18n10')"
              />
              <Iconfont :size="24" iconName="search" class="search-img"></Iconfont>
            </div>
        ...
        <div class="head-options">
          <div class="release">
            <div v-power="['indexList_addAtom', 'indexList_addCal']">
              ...
              >
                <div class="btm-index">
                  ...
                  <span class="btm-ins">{{ $t('i18n14') }}</span>
                </div>
              </n-dropdown>
            </div>
            <div
            ...
            >
              ...
              <span class="btm-ins">{{ $t('i18n15') }}</span>
            </div>
          </div>
    ...
    <n-drawer v-model:show="highFind.showScreen" :width="450">
      <n-drawer-content closable>
        ...
        <div class="find-content">
          <div class="find-item">
            <span class="find-text">{{ $t('i18n17') }}</span>
            <n-date-picker
              class="find-ipt"
          ...
          <div class="find-item">
            <span class="find-text">{{ $t('i18n19') }}</span>
            <n-select
              class="find-ipt"
              clearable
          ...
          <!-- <div class="find-item">
                        <span class="find-text">{{ $t('i18n8') }}</span>
                        <n-select class="find-ipt" clearable v-model:value="highFind.findStatus"
                            :options="highFind.statusOptions" />
                    </div> -->
          <div class="find-item">
            <span class="find-text">&emsp;{{ $t('i18n20') }}</span>
            <n-input
              class="find-ipt"
              clearable
              v-model:value="queryParams.createrName"
              type="text"
              :placeholder="$t('i18n21')"
            />
          </div>
        </div>
        <template #footer>
          <n-button type="info" @click="findIndexList">{{ $t('i18n11') }}</n-button>
        </template>
      </n-drawer-content>
    </n-drawer>
    ...
    >
      <div class="version-box">
        <div class="title-colse">
          <span class="title">{{ $t('i18n22') }}</span>
        ...
        <div class="version-food">
          <div class="cancel" @click="versionReactive.showVersion = false">{{ $t('i18n23') }}</div>
          <div class="start" @click="confirmVersion">{{ $t('i18n24') }}</div>
        </div>
      </div>
    </n-modal>
    ...
    <n-modal
      ...
      :title="$t('i18n25')"
      :content="$t('i18n26') + '?'"
      :positive-text="$t('i18n27')"
      :negative-text="$t('i18n23')"
...
const versionReactive = reactive({
  ...
  versionData: [
    ...
    { key: 3, code: "GDL_23", name: $t('i18n31'), type: $t('i18n32'), version: "1.0" },
    { key: 4, code: "GDL_23", name: $t('i18n31'), type: $t('i18n32'), version: "1.0" },
    { key: 5, code: "GDL_23", name: $t('i18n31'), type: $t('i18n32'), version: "1.0" },
  ],
  versionColumns: [
    ...
    { title: $t('i18n34'), key: "code", align: "center" },
    {
      title: $t('i18n35'),
      key: "name",
      align: "center",
    ...
    { title: $t('i18n36'), key: "version", align: "center" },
    {
      title: $t('i18n37'),
      key: "type",
      align: "center",
...
const listReactive = reactive({
  ...
  enums: {
    flowInsRes: [
      { label: $t('i18n38'), value: 1 },
      { label: $t('i18n39'), value: 0 },
      { label: $t('i18n40'), value: 4 },
    ],
    flowInsState: [
      { label: $t('i18n41'), value: 0 },
      { label: $t('i18n42'), value: 1 },
      { label: $t('i18n43'), value: 2 },
      { label: $t('i18n44'), value: 3 },
      { label: $t('i18n40'), value: 4 },
    ],
    status:[{label:$t('i18n45'),value:''},{label:$t('i18n46'),value:'2'},{label:$t('i18n47'),value:'1'},{label:$t('i18n48'),value:'0'}],
  },
  tableShow: true,
  ...
  tableColumns: [
    { title: $t('i18n34'), key: "gdlCode", ellipsis: true, isChecked: true, width: 180 },
    { title: $t('i18n35'), key: "gdlName", ellipsis: true, isChecked: true, width: 180 },
    {
      title: $t('i18n49'),
      key: "gdlType",
      align: "center",
    ...
    { title: $t('i18n53'), key: "dirName", align: "center", isChecked: true, width: 180 },
    {
      title: $t('i18n54'),
      key: "gdlCycleName",
      ellipsis: { title: true },
    ...
    // { title: '版本', key: 'version', align: "center" },
    {
      ...
      render(rowData: any) {
        return h(
          ...
          {
            default: () =>
              rowData.gdlStatus == 1 ? $t('i18n47') : rowData.gdlStatus == 2 ? $t('i18n46') : $t('i18n48'),
          }
        );
      },
    },
    ...
    { title: $t('i18n60'), key: "crtUserName", ellipsis: true, isChecked: false, width: 180 },

    { title: $t('i18n61'), key: "crtDt", ellipsis: true, isChecked: false, width: 160 },
    {
      title: $t('i18n62'),
      key: "modifyUserName",
      ellipsis: true,
    ...
    { title: $t('i18n63'), key: "modifyDt", ellipsis: true, isChecked: false, width: 160 },
  ],
  operateColumns: [],
  showColumns: [],
  tableData: [],
...
const init = () => {
  ...
  let powerList = [];
  if (findAtom != -1) powerList.push({ label: $t('i18n64'), key: "atom" });
  if (findComputed != -1) powerList.push({ label: $t('i18n65'), key: "computed" });
...
const initTableColimns = function () {
  ...
  findDelete != -1 && dropDownActions.push({ label: $t('i18n66'), key: "del" });
      ...
      render(row: any) {
        return h(TableAction as any, {
          ...
          dropDownActions: [
            ...
            {
              disabled:listReactive.isDisabled,
              label: row.gdlStatus == 0 ? $t('i18n47') : $t('i18n48'),
              key: "state",
              ifShow:
...
const onPositiveClickDel = async () => {
  ...
  if (res.status == 1) {
    message.info($t('i18n73'));
    nextTick(() => {
      initTableData();
    });
  } else {
    message.error(res.msg || $t('i18n74'));
  }
};
const findIndexList = () => {
  listReactive.pagination.page = 1;
...
const confirmVersion = () => {
  console.log($t('i18n24'));
}; //版本弹窗表选中
const confirmSetting = () => {
  console.log($t('i18n75'));
}; //自定义列弹窗表确认
      ...
      "div",
      {
        ...
        onClick: () => {
          if (column.key == "version") {
            ...
            console.log($t('i18n76'), rowData);
          } else {
            console.log($t('i18n77'), rowData);
          }
        },
      },
...
const switchGdlState = async (gdlId: number, state: number) => {
  ...
  if (res.code == "0000000") {
    message.success($t('i18n78'));
    findIndexList();
  } else {
    message.error($t('i18n79'));
  }
};
